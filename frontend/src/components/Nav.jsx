...
import logo from '../../public/img/1687297823359 (1).png'
    ...
    <>
      ...
      <nav className="nav">
          <div>
            ...
            <img src={logo} width={"29"} height={"29"} alt="" />
            ...
            {userPermissions.includes('Empleados') && (
            ...
            {userPermissions.includes('Servicios') && (
            ...
            {userPermissions.includes('Agenda') && (
            ...
            {userPermissions.includes('Pagos') && (
          ...
          <a href="/login" className="nav_link" onClick={handleLogout}>
