      ...
      <nav>
        <ol className="breadcrumb">
          ...
          <li className="breadcrumb-item active">
            <a href="/cliente">Gestión clientes</a>
          </li>
        </ol>
      </nav>
      </div>
        ...
        <div className="card-body">
          ...
          <div>
            <DataGrid
              ...
              columns={[
                { field: 'tipo_documento', headerName: 'TD', flex: 0.1,headerClassName: "encabezado-negro", },
                { field: 'documento', headerName: 'Documento', flex: 0.3,headerClassName: "encabezado-negro", },
                { field: 'nombre', headerName: 'Nombre', flex: 0.3, headerClassName: "encabezado-negro",},
                { field: 'apellidos', headerName: 'Apellido', flex: 0.4, headerClassName: "encabezado-negro",},
                { field: 'telefono', headerName: 'Teléfono', flex: 0.3, headerClassName: "encabezado-negro",},
                {
                  field: "estado",
                  headerName: "Estado",
                  flex: 0.2,
                ...
                { field: 'acciones', headerName: 'Acciones', flex: 0.2,headerClassName: "encabezado-negro",
                renderCell: (params) => (
                  <div>
                     <Tooltip title="Actualizar" arrow>
                      ...
                      {params.row.tieneCitas ? ( <Tooltip title="Eliminar" arrow>
                      <button className="btn btn-outline-dark me-1"
                      disabled
                      >
